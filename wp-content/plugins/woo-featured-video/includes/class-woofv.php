...
class WooCommerce_Featured_Video {
  ...
  public function render_video_box( $post ) {
    ...
    $link = sprintf( wp_kses( __( 'Replaces featured image with video. If you enjoy this plugin, please consider <a href="%s" target="_blank">donating</a>', 'woofv' ), array(  'a' => array( 'href' => array() ) ) ), esc_url( $url ) );
    echo $link;    
  ...
  public function replace_featured_image($html, $get_post_thumbnail_id){
    ...
    if ( !$video_url ) 
      ...
      $html  = '<div data-thumb="" class="woocommerce-product-gallery__image woofv_video"><a href="">';
